...
- Preview: https://main--aem-commerce-dropins--shreyas62.hlx.page/
- Live: https://main--aem-commerce-dropins--shreyas62.hlx.live/
...
1. Open the `aem-commerce-dropins` directory in your favorite IDE and start coding :)
